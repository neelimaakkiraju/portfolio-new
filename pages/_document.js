    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Senior Frontend Developer with expertise in React and Node.js, passionate about building impactful, intuitive, and high-performance user interfaces that drive results."
          />
